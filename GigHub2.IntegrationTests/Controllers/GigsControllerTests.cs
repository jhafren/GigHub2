...
using GigHub2.Core.ViewModels;
using GigHub2.IntegrationTests.Extensions;
...
namespace GigHub2.IntegrationTests.Controllers
{
    [TestFixture]
    public class GigsControllerTests
    {
        ...
        public void Update_WhenCalled_ShouldUpdateTheGivenGig()
        {
            ...
            {
                Id = gig.Id,
                Date = DateTime.Today.AddMonths(1).ToString("d.M.yyyy"),
                Time = "20:00",
                Venue = "Venue",
                Genre = 2
            });
